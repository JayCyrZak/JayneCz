package com.mygdx.josijalu_game.camera;
...
public class OrthoCamera extends OrthographicCamera {
    ...
    public OrthoCamera() {
        ...
        this(new VirtualViewport(JosijaluGameClass.WIDTH, JosijaluGameClass.HEIGHT));
    }
    ...
    public void resize() {
        VirtualViewport virtualViewport = new VirtualViewport(JosijaluGameClass.WIDTH, JosijaluGameClass.HEIGHT);
